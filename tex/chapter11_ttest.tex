...
\caption{jamovi results showing a `Paired Samples T-Test' where the actual hypothesis is one sided, i.e. that \texttt{grade\_test2} (`Measure 1') $>$ \texttt{grade\_test1} (`Measure 2')}
