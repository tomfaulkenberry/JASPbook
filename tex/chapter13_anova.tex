...
\begin{figure}[p]
\begin{center}
\epsfig{file = ../img/anova/anova5.png, clip=true,width = 12cm}
...
\begin{figure}[!htb]
\begin{center}
\epsfig{file = ../img/anova/RManova1.png, clip=true,width = 14cm}
...
\begin{figure}[!ht]
\begin{center}
\epsfig{file = ../img/anova/RManova6.png, clip=true,width = 12cm}
