...
\begin{center}{\Large {\bf Preface to Version 2.0}}\end{center}
\vspace*{12pt}

\noindent
Six years after its initial release, ``Learning Statistics with JASP'' continues to be widely used and cited, and I am grateful for the many positive messages I have received. However, the book has been in great need of a refresh, particularly with the many new updates to the JASP software that have happened in the past few years. In mid 2024, my graduate student Kylie Seifert began to help me refresh all the JASP screenshots to reflect the most current version. Thus, the book you're reading now reflects how JASP looks as of version 0.19.3...much better than the old version from 2019!  I am so grateful for her work this year.

I am also grateful to readers who have contributed suggestions and indentified typos, including Michael Katz, Oliver Schultheiss, and Rachel Stephens.  As always, I invite readers everywhere to find ways to make this text better (including identiying the ever-present typos).  Please send me an email if you'd like to contribute (or even better, go to my Github page and raise an issue there).
