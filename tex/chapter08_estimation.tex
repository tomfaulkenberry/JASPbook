...
\begin{figure}[p]
\begin{center}
\epsfig{file=../img/estimation/IQsim.pdf,clip=true,width=14cm}
\end{center}
...
\begin{figure}[p]
\begin{center}
\epsfig{file=../img/estimation/IQsample.pdf,clip=true,width=14cm}
\end{center}
...
$$
What this is telling us is that the range of values has a 95\% probability of containing the population mean $\mu$. We refer to this range as a \keyterm{95\% confidence interval}, denoted $\mbox{CI}_{95}$. In short, as long as $N$ is sufficiently large (large enough for us to believe that the sampling distribution of the mean is normal), then we can write this as our formula for the 95\% confidence interval:
$$
